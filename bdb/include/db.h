...
#pragma warning(disable: 4510) // '__log_rec_spec' : default constructor could not be generated
#pragma warning(disable: 4610) // struct '__log_rec_spec' can never be instantiated - user defined constructor required
#pragma warning(disable: 4512) // warning C4512: 'DbMultipleKeyDataBuilder' : assignment operator could not be generated
#endif /* _MSC_VER */
