...
namespace webserver {
	SettingApi::SettingApi(Session* aSession) : ApiModule(aSession) {
		METHOD_HANDLER(Access::SETTINGS_VIEW,	METHOD_POST, (EXACT_PARAM("items"), EXACT_PARAM("info")),	SettingApi::handleGetSettingInfos);
		METHOD_HANDLER(Access::ANY,				METHOD_POST, (EXACT_PARAM("items"), EXACT_PARAM("get")),	SettingApi::handleGetSettingValues);
		METHOD_HANDLER(Access::SETTINGS_EDIT,	METHOD_POST, (EXACT_PARAM("items"), EXACT_PARAM("set")),	SettingApi::handleSetSettings);
		METHOD_HANDLER(Access::SETTINGS_EDIT,	METHOD_POST, (EXACT_PARAM("items"), EXACT_PARAM("reset")),	SettingApi::handleResetSettings);
	}
