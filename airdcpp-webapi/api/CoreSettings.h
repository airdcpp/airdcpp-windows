...
namespace webserver {
	static const vector<ApiSettingItem> coreSettings = {
		...
		{ "dupe_min_size", SettingsManager::MIN_DUPE_CHECK_SIZE, ResourceManager::MIN_DUPE_CHECK_SIZE, ApiSettingItem::TYPE_GENERAL, { ResourceManager::Strings::KiB, false } },
		...
		{ "dl_slots", SettingsManager::DOWNLOAD_SLOTS, ResourceManager::SETTINGS_DOWNLOADS_MAX, ApiSettingItem::TYPE_LIMITS_DL },
		{ "dl_max_slot_speed", SettingsManager::MAX_DOWNLOAD_SPEED, ResourceManager::SETTINGS_DOWNLOADS_SPEED_PAUSE, ApiSettingItem::TYPE_LIMITS_DL, { ResourceManager::Strings::KiB, true } },
		...
		{ "ul_grant_speed", SettingsManager::MIN_UPLOAD_SPEED, ResourceManager::SETTINGS_UPLOADS_MIN_SPEED, ApiSettingItem::TYPE_LIMITS_UL, { ResourceManager::Strings::KiB, true } },
		{ "ul_max_granted", SettingsManager::AUTO_SLOTS, ResourceManager::SETTINGS_AUTO_SLOTS, ApiSettingItem::TYPE_LIMITS_UL },
		{ "ul_slots", SettingsManager::SLOTS, ResourceManager::SETTINGS_UPLOADS_SLOTS, ApiSettingItem::TYPE_LIMITS_UL },
		{ "ul_minislot_size", SettingsManager::SET_MINISLOT_SIZE, ResourceManager::SETCZDC_SMALL_FILES, ApiSettingItem::TYPE_GENERAL, { ResourceManager::Strings::KiB, false } },
		...
		{ "log_dir", SettingsManager::LOG_DIRECTORY, ResourceManager::SETTINGS_LOG_DIR, ApiSettingItem::TYPE_GENERAL },
