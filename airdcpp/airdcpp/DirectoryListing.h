...
public:
	...
	public:
		...
		BundleFileInfo::List toBundleInfoList() const noexcept;
	...
	protected:
		void toBundleInfoList(const string& aTarget, BundleFileInfo::List& aFiles) const noexcept;
	...
	optional<DirectoryBundleAddInfo> createBundleHooked(const Directory::Ptr& aDir, const string& aTarget, Priority aPrio, string& errorMsg_) noexcept;
