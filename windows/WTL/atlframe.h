...
protected:
	//  if all controls are done, free the text (if there is any)
	static void UICheckAndFreeText( _AtlUpdateUIData * pUIData )
	{
		if( 0 == (pUIData->m_wState & UPDUI_ALLTYPES)  && 0 != (pUIData->m_wState & UPDUI_TEXT) )
		{
