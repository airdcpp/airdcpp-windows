...
#ifndef WEBSHORT_PAGE_H
#define WEBSHORT_PAGE_H
...
class WebShortCutsPage : public CPropertyPage<IDD_WEB_SHORTCUTS_PAGE>, public PropPage
{
public:
	WebShortCutsPage(SettingsManager *s) : PropPage(s) {
		title = _tcsdup((TSTRING(SETTINGS_ADVANCED) + _T('\\') + TSTRING(WEBSHORTCUTS)).c_str());
	...
	BEGIN_MSG_MAP_EX(WebShortCutsPage)
